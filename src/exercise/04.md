...
J'ai appris l'intérêt de dériver l'état plutôt que de créer plusieurs états
([Don't Sync State. Derive It!](https://kentcdodds.com/blog/dont-sync-state-derive-it)).
Cette organisation du code permet d'éviter d'alourdir inutilement la
synchronisation des données. J'ai aussi pu pratiquer les hooks jusque-là décrits
comme `React.useState()`, `React.useEffect()` et les hooks personnalisés.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=hdessomme%40gmail.com).
