...
J'ai appris à utiliser le hook `hook` qui permet de définir une valeur qui peut
être ensuite modifier via une fonction qui déclencher un nouveau rendu du
composant.

La syntaxe est : `const [state, setState] = React.useState(initialValue)`
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=01%3A%20useState%3A%20greeting&em=hdessomme%40gmail.com).
